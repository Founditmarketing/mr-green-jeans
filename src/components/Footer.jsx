...
export default function Footer() {
  return (
    <footer style={{ background: 'var(--dark)', borderTop: '1px solid var(--glass-border)', padding: '5rem 2rem 2rem' }}>
      <div style={{ maxWidth: '1300px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '3rem' }}>
        ...
        <div>
          <h4 style={{ fontFamily: 'Barlow Condensed', fontSize: '0.9rem', fontWeight: 700, letterSpacing: '0.2em', textTransform: 'uppercase', color: 'var(--white)', marginBottom: '1.25rem' }}>Contact</h4>
          <ul style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
            <li><a href="tel:318-443-5894" style={{ color: 'var(--text)' }}>318-443-5894</a></li>
            <li><a href="mailto:info@sheltonenergy.com" style={{ color: 'var(--text)' }}>info@sheltonenergy.com</a></li>
            <li><a href="https://goo.gl/maps/iyc37Lib2cfxyCFP8" target="_blank" rel="noreferrer" style={{ color: 'var(--text)' }}>1439 Centre Court</a></li>
          </ul>
        </div>
